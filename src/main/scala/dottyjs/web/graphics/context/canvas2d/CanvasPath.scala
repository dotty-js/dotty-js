...
abstract trait CanvasPath extends js.Object:
  ...
  def ellipse(
      x: Double, y: Double, radiusX: Double, radiusY: Double, rotation: Double,
      startAngle: Double, endAngle: Double, counterclockwise: Boolean
  ): Unit = js.native
  ...
  def quadraticCurveTo(
      cpx: Double, cpy: Double, x: Double, y: Double
  ): Unit = js.native
  ...
  def roundRect(
      x: Double, y: Double, width: Double, height: Double, radii: js.Any
  ): Unit = js.native
end CanvasPath
